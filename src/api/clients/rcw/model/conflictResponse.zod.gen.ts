...
export const ConflictResponse = zod.object({
...
export type ConflictResponse = zod.input<typeof ConflictResponse>;
export type ConflictResponseOutput = zod.output<typeof ConflictResponse>;
