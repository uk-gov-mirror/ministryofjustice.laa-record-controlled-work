...
export const ForbiddenResponse = zod.object({
...
export type ForbiddenResponse = zod.input<typeof ForbiddenResponse>;
export type ForbiddenResponseOutput = zod.output<typeof ForbiddenResponse>;
